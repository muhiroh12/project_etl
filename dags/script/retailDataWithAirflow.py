    ...
    def load_to_database(self, df):
        try:
            with self.engine.connect() as connection:
                df.to_sql(name=self.table_name, con=connection, index=False, if_exists='append')
        except Exception as e:
...
def main():
    ...
    db_uri = 'postgresql+psycopg2://airflow:airflow@host.docker.internal:5433/airflow'
